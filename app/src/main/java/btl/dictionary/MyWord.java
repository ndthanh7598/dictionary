            ...
            public boolean onItemLongClick(final AdapterView<?> parent, final View view, final int position, long id) {
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (id){
                            case R.id.update:
                                String idtu = String.valueOf(id_tu);
                                intent = new Intent(MyWord.this, UpdateWordActivity.class);
                                intent.putExtra("id_tu", idtu);
                                startActivity(intent);
                                return true;
                            case R.id.delete:
                                final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(MyWord.this);
                                // khởi tạo dialog
                                ...
                                alertDialogBuilder.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface arg0, int arg1) {
                                        ...
                                        Intent intent = new Intent(MyWord.this,MyWord.class);
                                        startActivity(intent);
                                    }
                                });
